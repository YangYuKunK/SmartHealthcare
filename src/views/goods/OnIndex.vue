<template>
  <div class="goodsindex">
    ...
    <el-row :gutter="20" class="goodsindex-queryInfo">
      ...
      <!-- 查看下架商品信息 -->
      <el-col :xs="6" :sm="4" :md="3" :lg="2" :xl="2">
        <el-button type="success" class="goodsindex-queryInfo-li" size="small" @click="showoffindex">查看下架商品</el-button>
      </el-col>
      <!-- 返回商品列表 -->
      <el-col :xs="6" :sm="4" :md="3" :lg="2" :xl="2">
      ...
      <el-col :span="24">
        <el-table :data="tableData" border size='small' style="width: 100%">
          ...
          <el-table-column label="操作">
            <template slot-scope="scope">
              <el-button size="mini" @click="xia(scope.row)">下架</el-button>
            </template>
          </el-table-column>
        </el-table>
      </el-col>
...
export default {
  ...
  methods: {
    fun() {
      Axios({
        url: 'https://localhost:44388/api/Good/GetShelGoodList?state=0',
        method: 'get'
      }).then(ex => {
    ...
    //下架商品
    xia(row) {
      this.$confirm('确认将该商品下架么, 是否继续?', '提示', {
