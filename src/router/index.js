...
export const asyncRoutes = [
  ...
  // },
  {
    ...
    children: [
      ...
      {
        path: 'gc',
        component: () => import('@/views/goods/GC.vue'),
        name: 'goodgc',
        meta: {
          title: "查看回收站",
          icon: 'el-icon-tickets',
  ...
  },
  {
    ...
    children: [
      {
        path: 'index',
        component: () => import('@/views/Userse/Index.vue'),
        name: 'userseindex',
        meta: {
          title: "用户信息",
          icon: 'el-icon-tickets',
      ...
      {
        path: 'adduser',
        component: () => import('@/views/Userse/AddUserse.vue'),
        name: 'adduserse',
        meta: {
          title: "新增用户",
          icon: 'el-icon-tickets',
      ...
      {
        path: 'gc',
        component: () => import('@/views/Userse/GC.vue'),
        name: 'usergc',
        meta: {
          title: "用户回收站",
          icon: 'el-icon-tickets',
      ...
      {
        path: 'text',
        component: () => import('@/views/Userse/text.vue'),
        name: 'usertsxt',
        meta: {
          title: "测试",
          icon: 'el-icon-tickets',
